...
function munio_get_image_metadata( $image_id ){

    $image_metadata     = array();
    $image_title        = esc_html__("Image Title", 'munio');
    $image_caption      = "";
    $image_desc         = esc_html__("Image Description", 'munio');
...
function munio_hex2rgba($hex, $opacity = '0') {

    $rgbval = munio_hex2rgb( $hex );
