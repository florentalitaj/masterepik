									...
									<?php
										...
										while( $munio_portfolio->have_posts() ){
											...
											if( $munio_showcase_include == "yes" ){
												...
												?>
												<!-- Section Slide -->
												<div class="swiper-slide<?php if( $munio_hero_properties->video ) { echo " bg-video"; } ?>" data-number="<?php echo esc_attr( sprintf("%02d", $munio_slides_count) ); ?>" data-title="<?php echo esc_attr( $munio_hero_properties->caption_title ); ?>" data-subtitle="<?php echo esc_attr( $munio_hero_properties->caption_subtitle ); ?>">
													<div class="img-mask">
